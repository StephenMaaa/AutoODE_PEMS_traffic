...
br.select_form(nr=0)
br.form['username'] = 'jma@ucsd.edu' # getpass.getuser('jma@ucsd.edu')
br.form['password'] = 'rO7*blue' # getpass.getpass('rO7*blue')
            ...
            for d in ft[fileType]:
                ...
                for month in data.keys():
                    ...
                    for link in data[month]:
                        ...
                        if (prefix != "d04"): 
                            continue 
                        # # print(filename[27:29])
                        # # long_prefix = "d04_text_station_5min_2017_12"
                        # if ("d11_text_station_5min_2021_09_29" not in filename) and ("d11_text_station_5min_2021_09_30" not in filename): 
                        #     continue
                        # # if "d07_text_station_5min_2017_12_31" not in filename: 
                        # #     continue 
